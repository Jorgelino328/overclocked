...
var guns_destroyed = 0

signal start_phase_2()

func _ready() -> void:
	gun1.gun_destroyed.connect(_on_gun_1_destroyed)
	gun2.gun_destroyed.connect(_on_gun_2_destroyed)
...
func _on_gun_1_destroyed():
	gun1 = null
	guns_destroyed += 1
	
func _on_gun_2_destroyed():
	gun2 = null
	guns_destroyed += 1
